...
public class InteractionSystem : MonoBehaviour
{
    ...
    public GameObject interactionUI;  // 상호작용 UI패널
    ...
    void CheckForInteractables()
    {
        ...
        Collider[] hitColliders = Physics.OverlapSphere(checkPosition, interactionLayerMask);
        ...
        foreach(Collider collider in hitColliders)
        {
            ...
            if (interactable != null)
            {
                ...
                Vector3 diractionToObject = (collider.transform.position - playerTransform.position).normalized;
                float angle = Vector3.Angle(playerTransform.forward, diractionToObject);
